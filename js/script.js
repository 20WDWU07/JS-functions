...
$(document).ready(function(){
  ...
  //
  // });
  //console.log('this is outside the function', stay, food, totalCost);
  //not known because stay, food and totalCost are local variable has local scope
  //they are active inside the function where it is declared.
